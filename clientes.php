...
<title>Mi - Datos</title>
    ...
    <!--script src="js/sweetalert.min.js"></script-->    <!--script>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs" id="myTabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#post_index" role="tab" tabindex="3">
                                    <b><i style="width: 16px" class="fa fa-heart"></i> POST PARA INDEX</b>
                                </a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="post_index">
                            
                            <div class="tab-pane fade show active" id="post_index">
    <h1>REALIZA POST PARA SERVICIOS</h1>
    <!-- Formulario para publicar posts -->
    <form id="postForm">
        <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnAddExPersonal" class="btn btn-secondary" data-dismiss="modal">CERRAR</button>
            </div>
        </div>
    </div>
</div>
